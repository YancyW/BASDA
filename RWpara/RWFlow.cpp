...
void CFlow::   Read_Flow(CPath path){
	...
	RW_element("signal_property" ,flow_node,this->hmass           );
	...
	RW_element("MVA_training"    ,flow_node,this->BDT_training    );
	RW_element("MVA_level"       ,flow_node,this->BDT_level       );
	RW_element("MVA_weight"      ,flow_node,this->BDT_weight      );
}
