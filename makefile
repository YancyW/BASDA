...
SRCS = \
$(TARGET).cpp \
Class/BKG_Sort.cpp Class/Debug.cpp Class/Event.cpp Class/File.cpp Class/Flow.cpp Class/MVA.cpp   Class/Path.cpp Class/Plot.cpp Class/Scenario.cpp Class/Sensitivity.cpp Class/Signal_Properties_Scan.cpp \
