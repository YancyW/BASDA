...
void Cplot_setting::Print(){
	ShowMessage(1); 
	ShowMessage(2,"The Cplot_setting is:"); 
	ShowMessage(3,"show_title: ", show_title);
	ShowMessage(3,"line_width ", line_width);
	ShowMessage(3,"with_color_or_line: ", with_color_or_line);
}


void Cplot_drawing::Print(){
	
}

void Cplot_rootset::Print(){
